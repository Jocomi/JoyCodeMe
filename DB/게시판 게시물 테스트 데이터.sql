...
INSERT INTO ENQUIRY_BOARD (POST_NO, MEMBER_ID, POST_TITLE, POST_CONTENT, IMG_FILE, COUNT_VIEW, RECOMMEND, PRIVATE_BOARD, STATUS)
...
INSERT INTO PROJECT_BOARD (POST_NO, MEMBER_ID, POST_TITLE, POST_CONTENT, IMG_FILE, COUNT_VIEW, RECOMMEND, PRIVATE_BOARD, STATUS)
