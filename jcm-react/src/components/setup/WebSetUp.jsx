    ...
    return (
        <div className='websetup-container'>
          ...
          <div className="card">
            ...
            <input type="text" value={question} onChange={(e)=>setQuestion(e.target.value)} placeholder="만들고 싶은 웹사이트의 주제를 적어주세요..." required/>
            <Link to={['VIP1', 'VIP2', 'VIP3'].includes(grade) ? "form" : "/guide"}>
              <button 
                className="next-btn" 
                onClick={['VIP1', 'VIP2', 'VIP3'].includes(grade) ? setReqCtx : ()=>alert("사용 가능한 등급이 아닙니다.")}
              >
                Next →
              </button>
            </Link>
